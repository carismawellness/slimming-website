...
import { WeightLossFAQSection, EvidenceCard } from '@/components/weight-loss/WeightLossFAQClient';

export const metadata: Metadata = {
  title: "Medical Weight Loss Malta — Doctor-Led | Carisma Slimming",
...
function ProgramOverviewSection() {
  ...
  return (
    <section aria-labelledby="program-heading" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #F2F6EF 50%, #ffffff 100%)', paddingTop: 'clamp(12px, 3vw, 48px)', paddingBottom: 'clamp(12px, 3vw, 48px)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
...
function OurPromiseSection() {
  ...
  return (
    <>
      ...
      <section style={{ background: 'linear-gradient(180deg, #ffffff 0%, #eef3ea 50%, #ffffff 100%)', paddingTop: 'clamp(12px, 3vw, 48px)', paddingBottom: 0, overflow: 'hidden', position: 'relative' }}>
...
/* ============================================================
   7. FAQ — rendered by client component (interactive accordion)
   ============================================================ */

/* ============================================================
   7b. EVIDENCE BASED APPROACH — clinical research cards
   EvidenceCard is imported from WeightLossFAQClient (client component)
   ============================================================ */
