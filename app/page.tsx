...
export default function Home() {
  ...
  return (
    <div className="w-full">
      ...
      <section aria-labelledby="pillars-heading" style={{ backgroundColor: '#ffffff', paddingTop: 'clamp(40px, 8vw, 96px)', paddingBottom: 'clamp(40px, 8vw, 96px)' }}>
      ...
      <section aria-labelledby="modalities-heading" style={{ backgroundColor: '#ffffff', paddingTop: 'clamp(40px, 8vw, 96px)', paddingBottom: 'clamp(40px, 8vw, 96px)' }}>
