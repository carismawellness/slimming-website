...
export const services: Record<string, Service> = {
  'fat-freezing': {
    ...
    heroImage: '/wix/87fc13_af546d93467e47d790f061caff13348a~mv2.png',
    imagesNeeded: [
      { label: 'Group 1707481377.png', src: '/wix/87fc13_7685319028a14ef0ace54298d2e74acb~mv2.png' },
      { label: 'Backgroung.png', src: '/wix/87fc13_f0e92ac188af4582a4dcab0d17d5d2ed~mv2.png' },
      ...
      { label: 'CarismaSlim_Batch-33 (1) 1_edited_edited.png', src: '/wix/87fc13_af546d93467e47d790f061caff13348a~mv2.png' },
      ...
      { label: 'CarismaSlim_Batch-21 1_edited.png', src: '/wix/87fc13_bda5e64e4bcb4471b28a919528af71bc~mv2.png' },
      { label: 'Vector (30).png', src: '/wix/87fc13_eed9276b67e74ae99994e6bab4bcd409~mv2.png' },
      { label: 'Group 1707479766.png', src: '/wix/87fc13_59346c1121b34e759ebf20eba3054c8c~mv2.png' },
      { label: 'CoolSculpting Before & After', src: '/wix/87fc13_e873e3bf68584964b06a9f7bd9e5d335~mv2.png' },
      ...
      { label: 'Cryolipolysis', src: '/wix/87fc13_e49f864318254f4b86704307b14ca6d8~mv2.png' },
      { label: 'Localised Body Contour', src: '/wix/87fc13_8094f30674bc47208fac989787bf0557~mv2.png' },
      { label: 'Why We Combine', src: '/wix/87fc13_3ffa5b43365244309f4c746206cc1ecc~mv2.png' },
      { label: 'Rectangle 12134.png', src: '/wix/87fc13_5299fc2afac246a99d0def94c92bc3c1~mv2.png' },
      { label: 'Dr Zaid Teebi medical weight loss consultant Malta', src: '/wix/87fc13_523cfb315801437881171694d92d8d4f~mv2.png' },
      { label: 'Rectangle 12135.png', src: '/wix/87fc13_d8caba88b3084d04aef31e39cc2a6b2e~mv2.png' },
      { label: 'Dr Giovanni Scornavacca aesthetic doctor at Carisma Malta', src: '/wix/87fc13_e903680b4d124adda85e7ade5dfd676b~mv2.png' },
      { label: 'Dr Francesca Chircop aesthetic doctor at Carisma Malta', src: '/wix/87fc13_26127e01d9fb4ec48fb0b2f7ccb73508~mv2.png' },
      { label: 'lineVector.png', src: '/wix/87fc13_7502c14a8f8c4a5d8e75362f7366465a~mv2.png' },
      { label: 'Carisma Slimming Guide - sustainable weight loss management Malta', src: '/wix/87fc13_fae77cba7c5843e1ae57040ac00c3cce~mv2.png' },
      { label: 'Carisma Spa & Wellness', src: '/wix/87fc13_a62cc8038b274204a2fe70fd3d4879d0~mv2.png' },
      { label: 'SpaLogo.png', src: '/wix/87fc13_e2e5f077c0024cbc9a3d975e4a009b7e~mv2.png' },
      { label: 'Carisma Aesthetics Malta medical aesthetics treatments', src: '/wix/87fc13_bdc2b69242844d529915c2f20b2584ac~mv2.png' },
  ...
  'fat-dissolving': {
    ...
    imagesNeeded: [
      ...
      { label: 'Cryolipolysis', src: '/wix/87fc13_e49f864318254f4b86704307b14ca6d8~mv2.png' },
      { label: 'Fat Dissolving Injections', src: '/wix/87fc13_e1c0fd0d3df546909a3e1e2829768367~mv2.png' },
      { label: 'Localised Body Contour', src: '/wix/87fc13_8094f30674bc47208fac989787bf0557~mv2.png' },
      { label: 'Why We Combine', src: '/wix/87fc13_3ffa5b43365244309f4c746206cc1ecc~mv2.png' },
      { label: 'Rectangle 12134.png', src: '/wix/87fc13_5299fc2afac246a99d0def94c92bc3c1~mv2.png' },
      { label: 'Dr Zaid Teebi medical weight loss consultant Malta', src: '/wix/87fc13_523cfb315801437881171694d92d8d4f~mv2.png' },
  ...
  'muscle-stimulation': {
    ...
    imagesNeeded: [
      ...
      { label: 'Vector (30).png', src: '/wix/87fc13_eed9276b67e74ae99994e6bab4bcd409~mv2.png' },
      { label: 'Group 1707479766.png', src: '/wix/87fc13_59346c1121b34e759ebf20eba3054c8c~mv2.png' },
      { label: 'EMSculpt Neo', src: '/wix/87fc13_1a54a17987f64e6fb275b2721b8dc7f4~mv2.png' },
      ...
      { label: 'dollar-symbol.png', src: '/wix/87fc13_c4cf7001e0324fbd84551191d2a27bd1~mv2.png' },
      { label: 'parking-sign (1).png', src: '/wix/87fc13_0426ba92e1fa4e9ebce44215146be031~mv2.png' },
      { label: '415483.png', src: '/wix/87fc13_0b07a9fc055e494aa7490b9c55eb935b~mv2.png' },
      { label: '415484.png', src: '/wix/87fc13_9fd33781c744437abdb94bb6766a47fe~mv2.png' },
      { label: '415485.png', src: '/wix/87fc13_f7421e199b2e4fe7b08156e14260c090~mv2.png' },
      { label: '415486.png', src: '/wix/87fc13_846e99e2270a4d76b876c07a7cfe8915~mv2.png' },
      { label: 'Rectangle 12134.png', src: '/wix/87fc13_5299fc2afac246a99d0def94c92bc3c1~mv2.png' },
      { label: 'Dr Zaid Teebi medical weight loss consultant Malta', src: '/wix/87fc13_523cfb315801437881171694d92d8d4f~mv2.png' },
      { label: 'Rectangle 12135.png', src: '/wix/87fc13_d8caba88b3084d04aef31e39cc2a6b2e~mv2.png' },
      { label: 'Dr Giovanni Scornavacca aesthetic doctor at Carisma Malta', src: '/wix/87fc13_e903680b4d124adda85e7ade5dfd676b~mv2.png' },
  ...
  'skin-tightening': {
    ...
    heroImage: '/wix/87fc13_9b8bca36cbde4c16b23d79ab96ac5286~mv2.png',
    imagesNeeded: [
      { label: 'Group 1707481377.png', src: '/wix/87fc13_7685319028a14ef0ace54298d2e74acb~mv2.png' },
      { label: 'Backgroung.png', src: '/wix/87fc13_f0e92ac188af4582a4dcab0d17d5d2ed~mv2.png' },
      { label: 'google.png', src: '/wix/87fc13_c507b5f7e86f4eed970b757bc84a8ec4~mv2.png' },
      { label: 'Screen-Shot-2024-12-16-at-09.58.11-300x183-removebg-preview.png', src: '/wix/f940f0_c4008d16bc3245f7bc8663f5b60d7a82~mv2.png' },
      { label: 'Velashape III device', src: '/wix/87fc13_76c7882984cf42de95304b10e6fd263f~mv2.png' },
      { label: 'malta-today-logo.jpg', src: '/wix/f940f0_8c40f03f50684bf8adc6d9ca0cb2be9e~mv2.jpg' },
      { label: 'WhatsApp Image 2025-10-30 at 02.54.14.jpeg', src: '/wix/f940f0_e6f0bd96c9d04debaa8d8b609cbf68e6~mv2.jpeg' },
      { label: 'WhatsApp Image 2025-10-30 at 02.54.15 (1).jpeg', src: '/wix/f940f0_8bd141199fea4275a1222b62f24f2d98~mv2.jpeg' },
      { label: 'timesmalta.png', src: '/wix/f940f0_2120887ab6ef4957b02ff004e804beaf~mv2.png' },
      ...
      { label: '81 1.png', src: '/wix/87fc13_b4783b8ab4ad480fa01394e449f91d34~mv2.png' },
      { label: '78 1.png', src: '/wix/87fc13_729173bc08764a74bee017b037d95d5b~mv2.png' },
      { label: 'CarismaSlim_Batch-48 1.png', src: '/wix/87fc13_9b8bca36cbde4c16b23d79ab96ac5286~mv2.png' },
      { label: 'Vector (30).png', src: '/wix/87fc13_eed9276b67e74ae99994e6bab4bcd409~mv2.png' },
      { label: 'Group 1707479766.png', src: '/wix/87fc13_59346c1121b34e759ebf20eba3054c8c~mv2.png' },
      { label: 'Velashape III Before & After', src: '/wix/87fc13_056fc4bfc20b42c1ad5b0fbaddb94718~mv2.png' },
      { label: 'Line 1803.png', src: '/wix/87fc13_a33e3307da684fa0a47f3105d09dc796~mv2.png' },
      { label: 'location.png', src: '/wix/87fc13_387683ad0f4c499c8cab338b5f800aa0~mv2.png' },
      { label: 'rise.png', src: '/wix/87fc13_9011dffd287245ed9d60f5663e21edba~mv2.png' },
      { label: 'dollar-symbol.png', src: '/wix/87fc13_c4cf7001e0324fbd84551191d2a27bd1~mv2.png' },
      { label: 'parking-sign (1).png', src: '/wix/87fc13_0426ba92e1fa4e9ebce44215146be031~mv2.png' },
      { label: '415487.png', src: '/wix/87fc13_d160679a5a4f4729ac97ef7172222e36~mv2.png' },
      { label: '415488.png', src: '/wix/87fc13_c7f1f5fa97a24c65b42f750c0d47af08~mv2.png' },
      { label: '415489.png', src: '/wix/87fc13_93af23f487254333a309ca13e8732d59~mv2.png' },
      { label: '415490.png', src: '/wix/87fc13_880b5c63634f410b999a6d5b329e67d8~mv2.png' },
      { label: 'Rectangle 12134.png', src: '/wix/87fc13_5299fc2afac246a99d0def94c92bc3c1~mv2.png' },
      { label: 'Dr Zaid Teebi medical weight loss consultant Malta', src: '/wix/87fc13_523cfb315801437881171694d92d8d4f~mv2.png' },
      { label: 'Rectangle 12135.png', src: '/wix/87fc13_d8caba88b3084d04aef31e39cc2a6b2e~mv2.png' },
      { label: 'Dr Giovanni Scornavacca aesthetic doctor at Carisma Malta', src: '/wix/87fc13_e903680b4d124adda85e7ade5dfd676b~mv2.png' },
  ...
  'lipocavitation': {
    ...
    heroImage: '/wix/f940f0_3959a9b1203c41b09ca238cd2c75ee35~mv2.png',
    imagesNeeded: [
      { label: 'Group 1707481377.png', src: '/wix/87fc13_7685319028a14ef0ace54298d2e74acb~mv2.png' },
      { label: 'Backgroung.png', src: '/wix/87fc13_f0e92ac188af4582a4dcab0d17d5d2ed~mv2.png' },
      { label: 'google.png', src: '/wix/87fc13_c507b5f7e86f4eed970b757bc84a8ec4~mv2.png' },
      { label: 'daily story_apr26.png', src: '/wix/f940f0_e59104c7159440e4bb3ce6643acd584e~mv2.png' },
      { label: 'Screen-Shot-2024-12-16-at-09.58.11-300x183-removebg-preview.png', src: '/wix/f940f0_c4008d16bc3245f7bc8663f5b60d7a82~mv2.png' },
      { label: 'Untitled design.png', src: '/wix/f940f0_3959a9b1203c41b09ca238cd2c75ee35~mv2.png' },
      { label: 'malta-today-logo.jpg', src: '/wix/f940f0_8c40f03f50684bf8adc6d9ca0cb2be9e~mv2.jpg' },
      { label: 'WhatsApp Image 2025-10-30 at 02.54.14.jpeg', src: '/wix/f940f0_e6f0bd96c9d04debaa8d8b609cbf68e6~mv2.jpeg' },
      { label: 'WhatsApp Image 2025-10-30 at 02.54.15 (1).jpeg', src: '/wix/f940f0_8bd141199fea4275a1222b62f24f2d98~mv2.jpeg' },
      { label: 'timesmalta.png', src: '/wix/f940f0_2120887ab6ef4957b02ff004e804beaf~mv2.png' },
      ...
      { label: '81 1.png', src: '/wix/87fc13_b4783b8ab4ad480fa01394e449f91d34~mv2.png' },
      { label: '78 1.png', src: '/wix/87fc13_729173bc08764a74bee017b037d95d5b~mv2.png' },
      { label: 'Untitled design (1).png', src: '/wix/f940f0_4e251e5949424e95ab95d965c3b63716~mv2.png' },
      { label: 'Vector (30).png', src: '/wix/87fc13_eed9276b67e74ae99994e6bab4bcd409~mv2.png' },
      { label: 'Group 1707479766.png', src: '/wix/87fc13_59346c1121b34e759ebf20eba3054c8c~mv2.png' },
      { label: 'Velashape III Before & After', src: '/wix/87fc13_056fc4bfc20b42c1ad5b0fbaddb94718~mv2.png' },
      { label: 'Line 1803.png', src: '/wix/87fc13_a33e3307da684fa0a47f3105d09dc796~mv2.png' },
  ...
  'anti-cellulite': {
    ...
    imagesNeeded: [
      ...
      { label: 'Vector (30).png', src: '/wix/87fc13_eed9276b67e74ae99994e6bab4bcd409~mv2.png' },
      { label: 'Group 1707479766.png', src: '/wix/87fc13_59346c1121b34e759ebf20eba3054c8c~mv2.png' },
      { label: 'Velashape III', src: '/wix/87fc13_056fc4bfc20b42c1ad5b0fbaddb94718~mv2.png' },
      { label: 'Line 1803.png', src: '/wix/87fc13_a33e3307da684fa0a47f3105d09dc796~mv2.png' },
      { label: 'location.png', src: '/wix/87fc13_387683ad0f4c499c8cab338b5f800aa0~mv2.png' },
      { label: 'rise.png', src: '/wix/87fc13_9011dffd287245ed9d60f5663e21edba~mv2.png' },
      { label: 'dollar-symbol.png', src: '/wix/87fc13_c4cf7001e0324fbd84551191d2a27bd1~mv2.png' },
      { label: 'parking-sign (1).png', src: '/wix/87fc13_0426ba92e1fa4e9ebce44215146be031~mv2.png' },
      { label: 'Frame 1707482799.png', src: '/wix/87fc13_be8c4316bfbb46e9898da45f3e483bb2~mv2.png' },
      { label: 'Frame 1707482800.png', src: '/wix/87fc13_377a0ff5d9774c708ec911dee12739ce~mv2.png' },
      { label: 'Frame 1707482801.png', src: '/wix/87fc13_f1e71bcbbd304341985eb29e68c5e6c4~mv2.png' },
      { label: 'Frame 1707482802.png', src: '/wix/87fc13_24d04796e297434fb9b4f7682f7a9384~mv2.png' },
      { label: 'Rectangle 12134.png', src: '/wix/87fc13_5299fc2afac246a99d0def94c92bc3c1~mv2.png' },
      { label: 'Dr Zaid Teebi medical weight loss consultant Malta', src: '/wix/87fc13_523cfb315801437881171694d92d8d4f~mv2.png' },
      { label: 'Rectangle 12135.png', src: '/wix/87fc13_d8caba88b3084d04aef31e39cc2a6b2e~mv2.png' },
      { label: 'Dr Giovanni Scornavacca aesthetic doctor at Carisma Malta', src: '/wix/87fc13_e903680b4d124adda85e7ade5dfd676b~mv2.png' },
  ...
  'lymphatic-drainage': {
    ...
    heroImage: '/wix/87fc13_597101dd5e634161a957161a595de331~mv2.png',
    imagesNeeded: [
      { label: 'Group 1707481377.png', src: '/wix/87fc13_7685319028a14ef0ace54298d2e74acb~mv2.png' },
      { label: 'Backgroung.png', src: '/wix/87fc13_f0e92ac188af4582a4dcab0d17d5d2ed~mv2.png' },
      { label: 'google.png', src: '/wix/87fc13_c507b5f7e86f4eed970b757bc84a8ec4~mv2.png' },
      { label: 'Screen-Shot-2024-12-16-at-09.58.11-300x183-removebg-preview.png', src: '/wix/f940f0_c4008d16bc3245f7bc8663f5b60d7a82~mv2.png' },
      { label: 'Group 1707481653.png', src: '/wix/87fc13_c574290d2c144ad4b92ad39b34ba62d5~mv2.png' },
      { label: 'Lympathic Drainage', src: '/wix/87fc13_597101dd5e634161a957161a595de331~mv2.png' },
      { label: 'malta-today-logo.jpg', src: '/wix/f940f0_8c40f03f50684bf8adc6d9ca0cb2be9e~mv2.jpg' },
      { label: 'WhatsApp Image 2025-10-30 at 02.54.14.jpeg', src: '/wix/f940f0_e6f0bd96c9d04debaa8d8b609cbf68e6~mv2.jpeg' },
      { label: 'WhatsApp Image 2025-10-30 at 02.54.15 (1).jpeg', src: '/wix/f940f0_8bd141199fea4275a1222b62f24f2d98~mv2.jpeg' },
      { label: 'timesmalta.png', src: '/wix/f940f0_2120887ab6ef4957b02ff004e804beaf~mv2.png' },
      ...
      { label: 'dollar-symbol.png', src: '/wix/87fc13_c4cf7001e0324fbd84551191d2a27bd1~mv2.png' },
      { label: 'parking-sign (1).png', src: '/wix/87fc13_0426ba92e1fa4e9ebce44215146be031~mv2.png' },
      { label: 'Frame 1707482803.png', src: '/wix/87fc13_e7c53ad0e27445729ba68a17dd836565~mv2.png' },
      { label: 'Frame 1707482804.png', src: '/wix/87fc13_100cadcde0c24b41b6960e00c3e3a096~mv2.png' },
      { label: 'Frame 1707482805.png', src: '/wix/87fc13_48415cf7a9494953959c243e2171a5c4~mv2.png' },
      { label: 'Frame 1707482806.png', src: '/wix/87fc13_764464d670ba4b96823c473518ceddd4~mv2.png' },
      { label: 'Rectangle 12134.png', src: '/wix/87fc13_5299fc2afac246a99d0def94c92bc3c1~mv2.png' },
      { label: 'Dr Zaid Teebi medical weight loss consultant Malta', src: '/wix/87fc13_523cfb315801437881171694d92d8d4f~mv2.png' },
      { label: 'Rectangle 12135.png', src: '/wix/87fc13_d8caba88b3084d04aef31e39cc2a6b2e~mv2.png' },
      { label: 'Dr Giovanni Scornavacca aesthetic doctor at Carisma Malta', src: '/wix/87fc13_e903680b4d124adda85e7ade5dfd676b~mv2.png' },
