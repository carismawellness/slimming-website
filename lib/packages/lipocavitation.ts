...
export const lipocavitation: PackageContent = {
  id: 'lipocavitation',
  ...
  heroIncludes: [
    '4x Lipocavitation sessions (€400)',
  ...
  heroFineprint: [
    ...
    '** Additional sessions of Lipocavitation may be booked at €100 per session',
  ...
  ptEfficacyBullets: [
    ...
    'Visible inch loss: Most clients notice a measurable reduction in circumference in the treated area after completing a course of sessions.',
  ...
  dualMini: [
    ...
    { icon: W + 'f940f0_723eda38368c4415885adb03e592dc99~mv2.png', title: 'ULTRASOUND PRECISION TECHNOLOGY', body: 'Low-frequency ultrasound waves selectively break down fat cell membranes, leaving surrounding skin, nerves and tissue completely unaffected throughout.' },
  ],
  dualIncludes: [
    '4x Lipocavitation sessions (€400)',
    '4x access to spa & fitness facilities (€140)',
