...
export default function PreviewFooter() {
  return (
    <footer className="cx-footer" aria-label="Site footer" style={{ position: 'relative', background: '#2f3d33', color: 'rgba(255,255,255,0.82)', paddingTop: 'clamp(48px,6vw,80px)', overflow: 'hidden' }}>
      ...
      <div className="cx-wrap" style={{ position: 'relative', zIndex: 1, display: 'grid', gap: 'clamp(28px,4vw,56px)', gridTemplateColumns: '1fr' }}>
        <div className="cx-foot-grid" style={{ display: 'grid', gap: 'clamp(28px,4vw,48px)' }}>
          {/* brand */}
          <div>
            <a href="#top" aria-label="Carisma Slimming home page">
          ...
          <nav aria-label="Footer navigation">
            <h4 style={{ fontFamily: 'var(--wide)', fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(201,216,193,0.9)', marginBottom: 16 }}>Explore</h4>
          ...
          {/* contact */}
          <div>
            <h4 style={{ fontFamily: 'var(--wide)', fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(201,216,193,0.9)', marginBottom: 16 }}>Get in touch</h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: 11, fontFamily: 'var(--body)', fontSize: 13.5 }}>
              <li>
                <a
                  href={CONTACT.phoneHref}
                  className="cx-foot-link"
              ...
              <li style={{ display: 'flex', gap: 14, marginTop: 6 }}>
                <a
                  ...
                  className="cx-foot-link"
                  aria-label="Carisma Slimming on Instagram (opens in new tab)"
                  style={{ color: 'rgba(255,255,255,0.82)', textDecoration: 'none', fontSize: 12.5 }}
                >
                  Instagram
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                  className="cx-foot-link"
                  aria-label="Carisma Slimming on Facebook (opens in new tab)"
                  style={{ color: 'rgba(255,255,255,0.82)', textDecoration: 'none', fontSize: 12.5 }}
                >
                  Facebook
                </a>
        ...
        {/* medical disclaimer */}
        <p role="note" style={{ fontFamily: 'var(--body)', fontSize: 11.5, lineHeight: 1.7, color: 'rgba(255,255,255,0.5)', maxWidth: 880, borderTop: '1px solid rgba(255,255,255,0.12)', paddingTop: 24 }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, borderTop: '1px solid rgba(255,255,255,0.12)', marginTop: 32 }}>
        <div className="cx-wrap" style={{ display: 'flex', flexWrap: 'wrap', gap: 14, justifyContent: 'space-between', alignItems: 'center', paddingBlock: 20 }}>
          <span style={{ fontFamily: 'var(--body)', fontSize: 12, color: 'rgba(255,255,255,0.5)' }}>
            <small>© Carisma Slimming. All rights reserved.</small>
          </span>
          <span style={{ display: 'flex', gap: 18 }}>
            <a
              href="https://www.carismaslimming.com/privacy-policy"
              className="cx-foot-link"
              style={{ fontFamily: 'var(--body)', fontSize: 12, color: 'rgba(255,255,255,0.55)', textDecoration: 'none' }}
            >
              Privacy Policy
            </a>
            <a
              href="https://www.carismaslimming.com/terms-conditions"
              className="cx-foot-link"
              style={{ fontFamily: 'var(--body)', fontSize: 12, color: 'rgba(255,255,255,0.55)', textDecoration: 'none' }}
            >
              Terms &amp; Conditions
      ...
      <style>{`
        ...
        .cx-foot-link:focus-visible {
          outline: 2px solid rgba(201,216,193,0.9);
          outline-offset: 2px;
          border-radius: 2px;
        }
