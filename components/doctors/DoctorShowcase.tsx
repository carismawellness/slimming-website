    ...
    <section ref={rootRef} aria-labelledby="doctors-heading" style={{ background: '#fff', padding: 'clamp(48px,8vw,88px) 0' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <p
          ...
          style={{ color: TAUPE, fontFamily: '"Novecento Wide Book", sans-serif', fontSize: 12, letterSpacing: 2, textTransform: 'uppercase' }}
        >
        ...
        <h2
          id="doctors-heading"
          className="text-center"
          style={{ color: GREEN, fontFamily: '"Trajan Pro", serif', fontWeight: 400, fontSize: 'clamp(26px,4vw,40px)', textTransform: 'uppercase', margin: '6px 0 36px' }}
        >
          Meet Your Doctors
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div aria-live="polite">
            <h3 style={{ color: GREEN, fontFamily: '"Trajan Pro", serif', fontWeight: 400, fontSize: 'clamp(22px,3vw,30px)', textTransform: 'uppercase' }}>
              {d.name}
            </h3>
            <p style={{ color: TAUPE, fontFamily: '"Novecento Wide Book", sans-serif', fontSize: 12, letterSpacing: 1.5, textTransform: 'uppercase', margin: '6px 0 14px' }}>
              {d.role} · {d.years}
            </p>
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', color: GREEN, fontFamily: 'Roboto, sans-serif', fontSize: 13, textDecoration: 'underline', textUnderlineOffset: 2, cursor: 'pointer', marginTop: 8, padding: 0 }}
            >
        ...
        <div className="flex items-center justify-center gap-4" style={{ marginTop: 28 }}>
          <button type="button" aria-label="Previous doctor" onClick={() => go(active - 1)} disabled={active === 0} style={ctrlStyle(active === 0)}>
            ‹
          </button>
          ...
          <button type="button" aria-label="Next doctor" onClick={() => go(active + 1)} disabled={active === DOCTORS.length - 1} style={ctrlStyle(active === DOCTORS.length - 1)}>
            ›
          </button>
        </div>
      </div>
