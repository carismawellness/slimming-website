...
export default function BrandBlock() {
  ...
  useEffect(() => {
    // Respect prefers-reduced-motion: skip the entrance animation entirely
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <style>{`
              ...
              @media (prefers-reduced-motion: reduce) {
                .book-hidden { opacity: 1; }
                .book-visible { animation: none; opacity: 1; }
              }
            `}</style>
            <div
              ref={bookRef}
            ...
            <div>
              <h2 id="guide-heading" className="mb-6 pb-3" style={{ color: GREEN, fontFamily: 'Trajan Pro, serif', fontWeight: 400, fontSize: '26px', lineHeight: 1.4, letterSpacing: '1px', borderBottom: '1px solid #E6E1DC' }}>
                YOUR BIBLE TO SUSTAINABLE WEIGHT LOSS MANAGEMENT
              </h2>
              <div style={{ border: '1px solid #E6E1DC', borderRadius: '16px', padding: '20px 24px' }}>
                <p style={{ color: TAUPE, fontFamily: 'Roboto, sans-serif', fontSize: '14px', lineHeight: 1.7 }}>
      ...
      <section className="py-16" aria-labelledby="awards-heading" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center mb-12" style={{ gap: '40px' }}>
            <Image
              ...
              alt="Malta Healthcare, Wellness, Beauty and Best Spa Awards — Carisma Slimming winner"
              width={205}
              height={132}
              style={{ width: '205px', height: '132px', objectFit: 'cover', flexShrink: 0 }}
            />
            <div className="hidden md:block self-stretch" aria-hidden="true" style={{ width: '1px', backgroundColor: '#E0DAD3' }} />
            <div style={{ maxWidth: '470px' }}>
              <h2 id="awards-heading" style={{ color: GREEN, fontFamily: 'Roboto, sans-serif', fontSize: '19px', lineHeight: '1.8em', letterSpacing: '0.05em' }}>
          ...
          <style>{`
            [data-brand-cta]:hover { transform: scale(1.04); transition: transform 200ms ease; }
            [data-brand-cta]:active { transform: scale(0.97); }
            @media (prefers-reduced-motion: reduce) {
              [data-brand-cta]:hover { transform: none; }
              [data-brand-cta]:active { transform: none; }
            }
          `}</style>
              ...
              <div key={card.title} className="relative" style={{ height: '287px' }}>
                ...
                <div className="absolute flex flex-col justify-center" style={{ left: '64px', top: 0, bottom: 0 }}>
                  <Image
                    ...
                    width={218}
                    height={122}
                    style={{ width: '218px', height: '122px', objectFit: 'contain' }}
                  />
                  {card.reviews && (
                    <Image
                      src="/wix/87fc13_6e75c766df9749f48a8a564a1a88f57b~mv2.png"
                      alt="Google five-star rating — over 3,500 reviews"
                      width={213}
                      height={25}
                ...
                <a
                  ...
                  aria-label={`${card.cta} — opens in new tab`}
                  data-brand-cta
                  className="btn absolute text-white inline-flex items-center justify-center"
                  style={{ right: 0, bottom: '-20px', width: '278px', minHeight: '48px', backgroundColor: card.btnColor, fontFamily: '"Novecento Wide", sans-serif', fontSize: '12px', fontWeight: 700, letterSpacing: '0.5px', borderRadius: '999px' }}
                >
                  {card.cta}
                </a>
              </div>
