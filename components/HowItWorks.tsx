...
const bullet = { color: green, fontWeight: 700 as const, flexShrink: 0 as const };
        ...
        <div className="flex" style={{ borderBottom: '1px solid #e3ded6' }}>
          {tabs.map((t, i) => (
            <button
              ...
              style={{ color: active === i ? greenDark : taupeLight, fontFamily: wideFont, fontSize: '14px', letterSpacing: '2px', textTransform: 'uppercase', borderBottom: active === i ? `2px solid ${green}` : '2px solid transparent', marginBottom: '-1px', background: 'transparent', cursor: 'pointer' }}
            >
              {t}
            </button>
          ))}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl p-7">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h3 style={{ ...colHead, color: green }}>Your medical weight loss consultation</h3>
                </div>
              ...
              <div className="bg-white rounded-xl p-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="sm:pl-6" style={{ borderLeft: '1px solid #e3ded6' }}>
                  <div className="flex items-center gap-2 mb-5">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#AEC1A6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
